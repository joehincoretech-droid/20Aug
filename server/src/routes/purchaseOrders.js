...
purchaseOrdersRouter.get('/', requireRole('admin', 'po'), async (_req, res) => {
...
purchaseOrdersRouter.get('/next-number', requireRole('admin', 'po'), async (_req, res) => {
  res.json({ poNumber: await nextPoNumber() });
});

purchaseOrdersRouter.get('/:poNumber', async (req, res) => {
...
purchaseOrdersRouter.post('/', requireRole('admin', 'po'), async (req, res) => {
